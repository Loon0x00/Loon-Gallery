...
export default {
  ...
  created() {
    const PLUGINS_DATA_URL = "https://raw.githubusercontent.com/Loon0x00/Loon-Gallery/master/data/plugins.json";
    const SOURCES_DATA_URL = "https://raw.githubusercontent.com/Loon0x00/Loon-Gallery/master/data/repos.json";
